...
class ListScreen extends StatelessWidget {
  List<Widget> _generateVeggieRows(
      List<Veggie> veggies, Set<VeggieCategory> preferredCategories) {
  ...
  Widget build(BuildContext context) {
    return CupertinoTabView(
      builder: (context) {
        ...
        rows.addAll(_generateVeggieRows(
            appState.availableVeggies, prefs.preferredCategories));
        ...
        rows.addAll(_generateVeggieRows(
            appState.unavailableVeggies, prefs.preferredCategories));
